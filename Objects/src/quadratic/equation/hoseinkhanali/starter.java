...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "quadratic.equation.hoseinkhanali", "quadratic.equation.hoseinkhanali.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "quadratic.equation.hoseinkhanali.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
